...
abstract class AnimatedCustomText {
...
class AnimatedCustomeTextKit extends StatefulWidget {
  /// List of [AnimatedText] to display subsequently in the animation.
  final List animatedTexts;
  ...
  @override
  _AnimatedCustomeTextKitState createState() => _AnimatedCustomeTextKitState();
}

class _AnimatedCustomeTextKitState extends State<AnimatedCustomeTextKit>
    with TickerProviderStateMixin {
  late AnimationController _controller;

  late AnimatedCustomText _currentAnimatedText;
