...
class WavyAnimatedText extends AnimatedCustomText {
...
class WavyAnimatedCustomTextKit extends AnimatedCustomeTextKit {
  WavyAnimatedCustomTextKit({
    Key? key,
  ...
  static List<AnimatedCustomText> _animatedTexts(
    List<String> text,
    TextAlign textAlign,
    TextStyle? textStyle,
    Duration speed,
