...
class ChatReplyImageWidget extends StatefulWidget {
  ChatReplyImageWidget({super.key, required this.listOfChatDateDocument, required this.index, required this.receiverId, required this.name, required this.imageUrl, required this.replyId, required this.replyPhoneNumber, required this.isRead, required this.messageText, required this.sender, required this.time, required this.listOfChat});
  String sender;
  String messageText;
  int time;
  bool isRead;
  ...
  @override
  State<ChatReplyImageWidget> createState() => _ChatReplyImageWidgetState();
}

class _ChatReplyImageWidgetState extends State<ChatReplyImageWidget> {
